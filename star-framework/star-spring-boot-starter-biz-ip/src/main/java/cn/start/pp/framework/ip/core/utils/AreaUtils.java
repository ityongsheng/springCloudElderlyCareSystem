package cn.start.pp.framework.ip.core.utils;
...
import cn.start.pp.framework.ip.core.Area;
import cn.start.pp.framework.ip.core.enums.AreaTypeEnum;
...
import static cn.start.pp.framework.common.util.collection.CollectionUtils.findFirst;
