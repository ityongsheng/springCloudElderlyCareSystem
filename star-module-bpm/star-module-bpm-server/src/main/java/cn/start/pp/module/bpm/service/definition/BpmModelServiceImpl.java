package cn.start.pp.module.bpm.service.definition;
...
import cn.start.pp.module.bpm.controller.admin.definition.vo.model.BpmModelSaveReqVO;
import cn.start.pp.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.start.pp.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelUpdateReqVO;
import cn.start.pp.module.bpm.convert.definition.BpmModelConvert;
import cn.start.pp.module.bpm.dal.dataobject.definition.BpmFormDO;
import cn.start.pp.module.bpm.enums.definition.BpmModelFormTypeEnum;
...
import cn.start.pp.module.bpm.service.task.BpmProcessInstanceCopyService;
...
import static cn.start.pp.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.start.pp.module.bpm.enums.ErrorCodeConstants.*;
import static cn.start.pp.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseCandidateStrategy;
