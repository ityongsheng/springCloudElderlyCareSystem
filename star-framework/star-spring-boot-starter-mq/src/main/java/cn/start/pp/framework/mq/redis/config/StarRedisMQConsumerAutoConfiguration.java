...
import cn.start.pp.framework.common.enums.DocumentEnum;
import cn.start.pp.framework.mq.redis.core.RedisMQTemplate;
import cn.start.pp.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.start.pp.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import cn.start.pp.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import cn.start.pp.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class StarRedisMQConsumerAutoConfiguration {
