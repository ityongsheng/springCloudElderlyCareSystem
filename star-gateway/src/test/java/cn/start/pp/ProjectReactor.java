...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.star.gg";
    private static final String ARTIFACT_ID = "star";
    private static final String PACKAGE_NAME = "cn.start.pp";
    private static final String TITLE = "养老管理系统";
    ...
    public static void main(String[] args) {
        ...
        String titleNew = "养老管理系统";
        String projectBaseDirNew = "/Users/liyongsheng/studio/GraduationThesis/工职大论文/张效华--springcloud/new-backend" + "-new"; // 一键改名后，“新”项目所在的目录
