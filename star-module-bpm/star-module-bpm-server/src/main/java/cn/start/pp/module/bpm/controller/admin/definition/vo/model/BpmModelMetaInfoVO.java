package cn.start.pp.module.bpm.controller.admin.definition.vo.model;

import cn.start.pp.framework.common.core.KeyValue;
import cn.start.pp.framework.common.validation.InEnum;
import cn.start.pp.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.start.pp.module.bpm.enums.definition.BpmAutoApproveTypeEnum;
 ...
 *
 * 最终，它的字段和
 * {@link cn.start.pp.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO}
 * 是一致的
 *
 * @author 芋道源码
 */
...
public class BpmModelMetaInfoVO {
    ...
    @Schema(description = "流程图标", example = "https://www.iocoder.cn/star.jpg")
