package cn.start.pp.module.infra.controller.admin.codegen;
...
import cn.start.pp.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.start.pp.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.start.pp.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.start.pp.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.start.pp.module.infra.convert.codegen.CodegenConvert;
...
import cn.start.pp.module.infra.service.codegen.CodegenService;
...
import static cn.start.pp.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static cn.start.pp.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "star"),
