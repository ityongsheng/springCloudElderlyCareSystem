package cn.start.pp.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${star.websocket.sender-rocketmq.topic}",
        consumerGroup = "${star.websocket.sender-rocketmq.consumer-group}",
