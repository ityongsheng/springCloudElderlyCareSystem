package cn.start.pp.module.bpm.service.oa;

import cn.hutool.core.date.LocalDateTimeUtil;
import cn.start.pp.framework.common.pojo.PageResult;
import cn.start.pp.framework.common.util.object.BeanUtils;
import cn.start.pp.module.bpm.api.task.BpmProcessInstanceApi;
import cn.start.pp.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.start.pp.module.bpm.controller.admin.oa.vo.BpmOALeaveCreateReqVO;
import cn.start.pp.module.bpm.controller.admin.oa.vo.BpmOALeavePageReqVO;
import cn.start.pp.module.bpm.dal.dataobject.oa.BpmOALeaveDO;
import cn.start.pp.module.bpm.dal.mysql.oa.BpmOALeaveMapper;
...
import static cn.start.pp.module.bpm.enums.ErrorCodeConstants.OA_LEAVE_NOT_EXISTS;
