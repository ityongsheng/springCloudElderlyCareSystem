package cn.start.pp.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.start.pp.framework.common.enums.CommonStatusEnum;
import cn.start.pp.framework.common.exception.ServiceException;
import cn.start.pp.framework.common.pojo.CommonResult;
import cn.start.pp.framework.common.pojo.PageResult;
import cn.start.pp.framework.common.util.collection.ArrayUtils;
import cn.start.pp.framework.common.util.collection.CollectionUtils;
import cn.start.pp.framework.test.core.ut.BaseDbUnitTest;
import cn.start.pp.module.infra.api.config.ConfigApi;
import cn.start.pp.module.infra.api.file.FileApi;
import cn.start.pp.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.start.pp.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.start.pp.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.start.pp.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.start.pp.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.start.pp.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.start.pp.module.system.dal.dataobject.dept.DeptDO;
import cn.start.pp.module.system.dal.dataobject.dept.PostDO;
import cn.start.pp.module.system.dal.dataobject.dept.UserPostDO;
import cn.start.pp.module.system.dal.dataobject.tenant.TenantDO;
import cn.start.pp.module.system.dal.dataobject.user.AdminUserDO;
import cn.start.pp.module.system.dal.mysql.dept.UserPostMapper;
import cn.start.pp.module.system.dal.mysql.user.AdminUserMapper;
import cn.start.pp.module.system.enums.common.SexEnum;
import cn.start.pp.module.system.service.dept.DeptService;
import cn.start.pp.module.system.service.dept.PostService;
import cn.start.pp.module.system.service.permission.PermissionService;
import cn.start.pp.module.system.service.tenant.TenantService;
...
import static cn.start.pp.framework.common.util.collection.SetUtils.asSet;
import static cn.start.pp.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.start.pp.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.start.pp.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.start.pp.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.start.pp.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.start.pp.framework.test.core.util.RandomUtils.*;
import static cn.start.pp.module.system.enums.ErrorCodeConstants.*;
import static cn.start.pp.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("staryuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("staryuanma");
        ...
        assertEquals("staryuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("staryuanma"))).thenReturn("java");
