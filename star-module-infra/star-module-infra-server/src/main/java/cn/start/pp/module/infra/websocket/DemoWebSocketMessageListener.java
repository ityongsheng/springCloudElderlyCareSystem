package cn.start.pp.module.infra.websocket;
...
import cn.start.pp.framework.websocket.core.util.WebSocketFrameworkUtils;
import cn.start.pp.module.infra.websocket.message.DemoReceiveMessage;
import cn.start.pp.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 star.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
