package cn.start.pp.module.bpm.convert.task;
...
import cn.start.pp.framework.common.util.collection.SetUtils;
...
import cn.start.pp.module.bpm.controller.admin.base.user.UserSimpleBaseVO;
...
import cn.start.pp.module.bpm.controller.admin.definition.vo.process.BpmProcessDefinitionRespVO;
import cn.start.pp.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO;
import cn.start.pp.module.bpm.controller.admin.task.vo.instance.BpmProcessInstanceBpmnModelViewRespVO;
import cn.start.pp.module.bpm.controller.admin.task.vo.instance.BpmProcessInstanceRespVO;
import cn.start.pp.module.bpm.controller.admin.task.vo.instance.BpmProcessPrintDataRespVO;
import cn.start.pp.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.start.pp.module.bpm.convert.definition.BpmProcessDefinitionConvert;
import cn.start.pp.module.bpm.dal.dataobject.definition.BpmCategoryDO;
import cn.start.pp.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.start.pp.module.bpm.api.event.BpmProcessInstanceStatusEvent;
...
import cn.start.pp.module.bpm.service.message.dto.BpmMessageSendWhenProcessInstanceApproveReqDTO;
import cn.start.pp.module.bpm.service.message.dto.BpmMessageSendWhenProcessInstanceRejectReqDTO;
...
import static cn.start.pp.framework.common.util.collection.CollectionUtils.convertList;
