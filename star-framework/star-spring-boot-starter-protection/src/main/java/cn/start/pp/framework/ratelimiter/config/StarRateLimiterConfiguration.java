package cn.start.pp.framework.ratelimiter.config;

import cn.start.pp.framework.ratelimiter.core.aop.RateLimiterAspect;
import cn.start.pp.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import cn.start.pp.framework.ratelimiter.core.keyresolver.impl.*;
...
public class StarRateLimiterConfiguration {
