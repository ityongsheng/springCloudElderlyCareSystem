package cn.start.pp.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import cn.start.pp.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.start.pp.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
