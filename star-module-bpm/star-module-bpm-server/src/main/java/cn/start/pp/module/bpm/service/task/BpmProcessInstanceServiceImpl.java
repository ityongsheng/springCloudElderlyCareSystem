package cn.start.pp.module.bpm.service.task;
...
import cn.start.pp.framework.common.util.date.DateUtils;
import cn.start.pp.framework.common.util.json.JsonUtils;
import cn.start.pp.framework.common.util.object.ObjectUtils;
import cn.start.pp.framework.common.util.object.PageUtils;
import cn.start.pp.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.start.pp.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.start.pp.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.start.pp.module.bpm.controller.admin.task.vo.instance.*;
import cn.start.pp.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.start.pp.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.start.pp.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.start.pp.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.start.pp.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.start.pp.module.bpm.enums.ErrorCodeConstants;
import cn.start.pp.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.start.pp.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.start.pp.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.start.pp.module.bpm.enums.task.BpmReasonEnum;
import cn.start.pp.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.start.pp.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.start.pp.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.start.pp.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.start.pp.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.start.pp.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.start.pp.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.start.pp.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.start.pp.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.start.pp.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.start.pp.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.start.pp.module.bpm.service.message.BpmMessageService;
...
import static cn.start.pp.framework.common.exception.util.ServiceExceptionUtil.exception;
import static cn.start.pp.framework.common.util.collection.CollectionUtils.*;
import static cn.start.pp.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.start.pp.module.bpm.enums.ErrorCodeConstants.*;
import static cn.start.pp.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.start.pp.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_NEED_SIMULATE_PREFIX;
import static cn.start.pp.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
