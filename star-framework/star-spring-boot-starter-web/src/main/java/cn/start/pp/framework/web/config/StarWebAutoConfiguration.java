package cn.start.pp.framework.web.config;
...
import cn.start.pp.framework.web.core.filter.CacheRequestBodyFilter;
import cn.start.pp.framework.web.core.filter.DemoFilter;
import cn.start.pp.framework.web.core.handler.GlobalExceptionHandler;
import cn.start.pp.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class StarWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "star.demo", havingValue = "true")
