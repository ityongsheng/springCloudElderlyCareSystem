package cn.start.pp.module.bpm.framework.flowable.core.behavior;

import cn.hutool.core.collection.CollUtil;
import cn.start.pp.framework.common.util.collection.SetUtils;
import cn.start.pp.module.bpm.enums.definition.BpmChildProcessMultiInstanceSourceTypeEnum;
...
public class BpmSequentialMultiInstanceBehavior extends SequentialMultiInstanceBehavior {
    ...
    protected void executeOriginalBehavior(DelegateExecution execution, ExecutionEntity multiInstanceRootExecution, int loopCounter) {
        ...
        // 参见 https://gitee.com/zhijiantianya/star-cloud/issues/IC239F
