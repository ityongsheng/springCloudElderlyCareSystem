package cn.start.pp.framework.common.biz.system.oauth2;

import cn.start.pp.framework.common.enums.RpcConstants;
...
public interface OAuth2TokenCommonApi {
    ...
    @Parameters({
        ...
        @Parameter(name = "clientId", description = "客户端编号", required = true, example = "staryuanma")
    })
