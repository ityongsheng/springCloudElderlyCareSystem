package cn.start.pp.module.infra.service.logger;
...
import cn.start.pp.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.start.pp.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.start.pp.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.start.pp.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.start.pp.framework.common.util.date.LocalDateTimeUtils.*;
...
import static cn.start.pp.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.start.pp.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("star-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("star-test");
