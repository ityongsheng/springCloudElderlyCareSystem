 ...
 *      1）Spring Async：
 *          {@link cn.start.pp.framework.quartz.config.StarAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 StarSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.start.pp.framework.tenant;
