package cn.start.pp.framework.jackson.config;

import cn.start.pp.framework.common.util.json.JsonUtils;
import cn.start.pp.framework.common.util.json.databind.NumberSerializer;
import cn.start.pp.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.start.pp.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class StarJacksonAutoConfiguration {
