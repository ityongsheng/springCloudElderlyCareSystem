package cn.start.pp.module.system.service.social;
...
import cn.start.pp.framework.common.enums.UserTypeEnum;
import cn.start.pp.framework.common.pojo.PageResult;
import cn.start.pp.framework.common.util.cache.CacheUtils;
import cn.start.pp.framework.common.util.http.HttpUtils;
import cn.start.pp.framework.common.util.object.BeanUtils;
import cn.start.pp.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.start.pp.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.start.pp.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import cn.start.pp.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cn.start.pp.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.start.pp.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.start.pp.module.system.dal.dataobject.social.SocialClientDO;
import cn.start.pp.module.system.dal.mysql.social.SocialClientMapper;
import cn.start.pp.module.system.dal.redis.RedisKeyConstants;
import cn.start.pp.module.system.enums.social.SocialTypeEnum;
import cn.start.pp.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.start.pp.framework.common.util.collection.MapUtils.findAndThen;
import static cn.start.pp.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.start.pp.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static cn.start.pp.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${star.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${star.wxa-subscribe-message.miniprogram-state:formal}")
